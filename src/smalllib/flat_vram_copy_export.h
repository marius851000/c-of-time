...
struct SomeFlatVRAMAllocContainer {
    struct copy_to_obj_vram_order copy_to_sprite_vram_command[223];
...
struct AnotherRenderAllocStuff { /* 112 bytes memzeroed on init */
    ...
    struct SomeFlatVRAMAllocContainer *sprite_vram_copy_command;
    ...
    struct astruct_31 field25_0x20;
